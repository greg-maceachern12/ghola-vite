...
const Hero = () => {
  ...
  // Updated form submit handler: bypass throttling if premium
  ...
  // Display indicator based on premium status
  ...
  return (
    <div className="relative min-h-screen text-white overflow-hidden">
      ...
      <div className="fixed top-0 left-0 right-0 py-3 px-6 backdrop-blur-md bg-black/30 border-b border-white/10 z-20 flex justify-between items-center">
        ...
        {premium ? (
          <div className="flex items-center gap-2 text-sm text-green-400">
            <span>Premium Active – Unlimited HD Generations</span>
          </div>
        ) : throttled ? (
      ...
      <main className="relative flex flex-col items-center justify-center min-h-screen py-24 px-6">
        ...
        {/* Premium Access Section with License Validation */}
...
<div className="w-full max-w-2xl mx-auto mt-20 mb-12 relative">
        ...
        {/* <div className="w-full max-w-2xl mx-auto mt-20 mb-12"> */}
          <LemonSqueezyPayment
